...
class MyColor {
  static const Color primaryColor = Color(0xffFF8D8C);
  static const Color secondaryColor = Color(0xFFD82E85);
  static const Color thirdColor = Color(0xffF7EAFB);
  //Screen
  static const Color screenBgColor = Color(0xFFFEEDED);
  //Card
  static const Color cardBgColor = Color(0xFFFFFFFF);
  // Button
  static const Color buttonBgColor = Color(0xFFD82E85);

  //Text
  static const Color primaryTextColor = Color(0xff262626);
  static const Color secondaryTextColor = Color(0xffEA8DBC);
